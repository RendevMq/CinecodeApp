...
val Blue10 = Color(0xFFCB2600)
val Blue20 = Color(0xFF001E92)
val Blue30 = Color(0xFF002ECC)
val Blue40 =  Color(0xFFFD7C53)
val Blue80 = Color(0xFFFF6E40)
//val Blue90 = Color(0xFFDDE1FF)
val Blue90 = Color(0xFFCB6040)

val DarkBlue10 = Color(0xFF111118) //icon selected
val DarkBlue20 = Color(0xFF000BA6)
val DarkBlue30 = Color(0xFFFF6E40) //bottom bar dark selected icon
val DarkBlue40 = Color(0xFF3648EA)
val DarkBlue80 = Color(0xFFBBC2FF)
val DarkBlue90 = Color(0xFFF1C3B5) //bottom bar light selected icon
